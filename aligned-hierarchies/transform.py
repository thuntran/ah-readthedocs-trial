...
This file contains the following functions:
    ...
    * :ref:`remove_overlaps <remove_overlaps>`
        Removes any pairs of repeats with the same length and 
        annotation marker where at least one pair of repeats overlap in time
    
    * :ref:`__create_anno_remove_overlaps <__create_anno_remove_overlaps>` 
    ...
    * :ref:`__separate_anno_markers <__separate_anno_markers>`
        Expands vector of non-overlapping repeats into
